...
.setHTML(`<h5 class='title is-5 tool-tip-title'>${item.name}</h5>
            ...
            <div class='card' style='margin-top: 0.5rem; margin-bottom: 0.5rem'>
              ...
              <div class='card-content' style='padding: 0.5rem'>
                ...
                <div class='content' style='margin-bottom: 0.5rem'>
                  ${item.description}
                  <hr/>
                  Bởi <a href='#'>${item.full_name}</a> (${item.points})
                  ...
                  <div class='tool-bar'>
                    <div class='columns' style='margin: 0'>
                      <button type='button' class='button is-success is-outlined column action-btn'>
                        <span class='icon is-large'><i class='fa fa-thumbs-up'></i></span> ${item.description.length}
                      </button>
                      <button type='button' class='button is-danger is-outlined column action-btn'>
                        <span class='icon is-large'><i class='fa fa-thumbs-down'></i></span> ${item.name.length}
                      </button>
